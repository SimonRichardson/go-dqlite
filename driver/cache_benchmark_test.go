...
func BenchmarkStmtCache_Put(b *testing.B) {
	benchmarks := []struct {
		...
		{name: "Small_10", capacity: 10, queries: 10},
		{name: "Medium_100", capacity: 100, queries: 100},
		{name: "Large_1000", capacity: 1000, queries: 1000},
		{name: "Overflow_10_100", capacity: 10, queries: 100}, // Tests LRU eviction
	}
...
func BenchmarkStmtCache_TryGet_Miss(b *testing.B) {
	benchmarks := []struct {
		...
		{name: "Small_10", capacity: 10, cached: 10},
		{name: "Medium_100", capacity: 100, cached: 100},
		{name: "Large_1000", capacity: 1000, cached: 1000},
	}
